...
public class WellnessWave extends javax.swing.JFrame {
...
//    C:\Users\simple-coding-setup\Documents\programming\PRT2\MainApp\src\main\java\com\mycompany\mainapp\icons\profile.png
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WellnessWave.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WellnessWave().setVisible(true);
            }
        });
    }
